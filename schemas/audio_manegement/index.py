...
# All queries
queries = (song_query, album_query, playlist_query, tag_query, tags_song_query)
mutations = (song_mutation, album_mutation, playlist_mutation, tag_mutation, tags_song_mutation)
